...
_ZHIPU_MOD = _load_sibling_module("smj_pipeline_llm_zhipu_client_for_registry", "zhipu_client.py")
_NVIDIA_MOD = _load_sibling_module("smj_pipeline_llm_nvidia_client_for_registry", "nvidia_client.py")
