...
_SCRIPTS_SMJ_DIR = _REPO_ROOT / "scripts" / "smj_pipeline"
...
def extract_records_with_raw(document_html: str, llm_client: LLMClient) -> tuple[ExtractionBundle, str]:
    prompts_module = _load_smj_module("smj_pipeline_extraction_prompts", "extraction/prompts.py")
...
def _load_smj_module(module_name: str, relative_path: str):
