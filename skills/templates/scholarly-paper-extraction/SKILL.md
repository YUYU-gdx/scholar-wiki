...
5. 若需要澄清，调用 `weaviate_fetch_object(paper_id_or_doi="...")` 查看源论文原文对比
...
3. 用 `weaviate_fetch_object(paper_id_or_doi="...")` 调取源文献原文对比
...
- `weaviate_query(query, top_k, library_id)`: 补充召回
- `weaviate_fetch_object(paper_id_or_doi)`: 获取论文对象详情
